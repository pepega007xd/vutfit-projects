...
/// returns true if character is either alphanumeric, or a dash (-)
...
/// returns true if the vector contains only printable characters,
/// including CR and LF characters
bool is_printable_string(u8Vec string);
